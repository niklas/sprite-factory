...
module SpriteFactory
  class StyleTest < SpriteFactory::TestCase
    ...
    def test_generate
      ...
      images   = [
        build_image(nil, nil, :filename => '/path/to/sprite1.png', :name => 'sprite1', :cssx => 1, :cssy => 10, :cssw => 100, :cssh => 1000),
        build_image(nil, nil, :filename => '/path/to/sprite2.png', :name => 'sprite2', :cssx => 2, :cssy => 20, :cssw => 200, :cssh => 2000),
        build_image(nil, nil, :filename => '/path/to/sprite3.png', :name => 'sprite3', :cssx => 3, :cssy => 30, :cssw => 300, :cssh => 3000),
        build_image(nil, nil, :filename => '/path/to/sprite4.png', :name => 'sprite4', :cssx => 4, :cssy => 40, :cssw => 400, :cssh => 4000),
        build_image(nil, nil, :filename => '/path/to/sprite5.png', :name => 'sprite5', :cssx => 5, :cssy => 50, :cssw => 500, :cssh => 5000)
      ]
